...
global.ownername = "الدكتاتور الارستقراطي " //ur owner name
...
global.mess = {
    success: 'تم ازهلني',
    admin: '『 لاتسوي خوي الأمر للادمنيه』',
    botAdmin: '『 ارفع البوت مشرف طيب! 』',
    premime: '『 ميزات خاصة متميزة إذا كنت ترغب في تسجيل نوع الإيجار 』',
    owner: '『 هديها شوي الأمر للمطور  』',
    group: '『 الميزه للقروبات بس 』',
    private: '『 الميزه استخدمها بالخاص 』',
    bot: '『 يافله الميزه ذي للبوت بس 』',
    wait: '『 خلك صبور… 』',
    linkm: '『 الرابط وين؟ 』',
